plot_holder_curves_mu_con <- function(data = NA, lod1 = 15e3, lod2 = 40e6, idnum = c("19","20")){
  
  mycols19 = c("4.8" = colorblind_pal()(8)[1], 
               "48" = colorblind_pal()(8)[2], 
               "4800" = colorblind_pal()(8)[3])
  
  mycols20 = c("0.48" = colorblind_pal()(8)[8], 
               "4.8" = colorblind_pal()(8)[1], 
               "48" = colorblind_pal()(8)[2], 
               "4800" = colorblind_pal()(8)[3])
  ...
  if (idnum == "20") {
    holder_curves_mu_plot1 <- ggplot(data = data)+
      ...
      geom_hline(yintercept=lod2, linetype="dashed", size = 0.5, alpha = 0.5) +
      annotate(geom = 'text', label = c("LOD1","LOD2"), x = c(5, 5), y = c(lod1*0.5,lod2*0.4), hjust = 0, vjust = 1, size = 3) +
      scale_colour_manual(values = mycols20) +
