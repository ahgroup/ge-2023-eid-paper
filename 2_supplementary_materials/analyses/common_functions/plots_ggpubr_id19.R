plots_ggpubr_id19 <- function(plot_list = NA, width = NA){
  ...
  dose48 <- ggarrange(plot_list[[7]] + clean_theme1, 
                      ...
                      plot_list[[13]] + clean_theme2,
                      nrow = 1, widths = c(width1,rep(1,6)))
  
  dose4.8 <- ggarrange(plot_list[[14]] + clean_theme1, 
                       plot_list[[15]] + clean_theme2, 
                       plot_list[[16]] + clean_theme2, 
                       plot_list[[17]] + clean_theme2, 
                       plot_list[[18]] + clean_theme2, 
                       plot_list[[19]] + clean_theme2,
                       NA,
                       nrow = 1, widths = c(width1,rep(1,6)))
  
  plot_id <- ggarrange(dose4.8, dose48, dose4800, nrow = 3, heights = c(1,1,1.42))
